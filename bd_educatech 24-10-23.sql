...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Out-2023 às 16:54
...
--
-- Estrutura da tabela `comentario_aula`
--
...
--
-- Estrutura da tabela `media_aluno`
--
...
--
-- Estrutura da tabela `tarefa_aula`
--
...
--
-- Estrutura da tabela `turma_fund1_responsavel`
--
...
--
-- Extraindo dados da tabela `turma_fund1_responsavel`
--
...
--
-- Índices para tabela `comentario_aula`
--
...
--
-- Índices para tabela `docente_disciplina`
--
...
--
-- Índices para tabela `media_aluno`
--
...
--
-- Índices para tabela `tarefa_aula`
--
...
--
-- Índices para tabela `turma_fund1_responsavel`
--
...
--
-- Limitadores para a tabela `comentario_aula`
--
ALTER TABLE `comentario_aula`
...
--
-- Limitadores para a tabela `media_aluno`
--
ALTER TABLE `media_aluno`
...
--
-- Limitadores para a tabela `tarefa_aula`
--
ALTER TABLE `tarefa_aula`
...
--
-- Limitadores para a tabela `turma_fund1_responsavel`
--
ALTER TABLE `turma_fund1_responsavel`
